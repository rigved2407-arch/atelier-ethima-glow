...
export const PRODUCTS: Product[] = [
  ...
  {
    id: "ETH-RG-003",
    slug: "twisted-pave-solitaire",
    name: "Twisted Pavé Solitaire",
    category: "rings",
    collection: "The Signature Edit",
    description:
      "A modern take on the classic solitaire, this ring features a graceful twisted band with pavé diamond detailing. The design balances softness and structure, making it ideal for someone who wants a statement that still feels refined.",
    shortDescription: "Twisted pavé band with solitaire centre.",
    designType: "Twisted Pavé Solitaire",
    stoneType: "Lab-grown diamond",
    stoneShapeOptions: "Round / Oval / Pear",
    sizeOptions: "Ring sizes",
    customizable: true,
    inventoryModel: "Made-to-order",
    launchPriority: "Premium launch",
    primaryChannel: "Website + Consultation",
    notes: "Use as higher perceived-value design",
    images: {
      silver: ["/products/twisted-pave-solitaire/1.png"],
      gold: ["/products/twisted-pave-solitaire/1.png"],
      vermeil: ["/products/twisted-pave-solitaire/1.png"],
    },
    variants: [
      {
        sku: "ETH-RG-003-VRM",
        metal: "Gold Vermeil on 925 Silver",
        weight: "3.0 gms",
        diamondDetails: "1.50 mm x 56 pcs, 6.00 mm x 1 pc",
        totalCarat: 1.52,
        price: 36000,
      },
      {
  ...
  },
  {
    ...
    description:
      "A personal piece designed around your identity. The Initial Pendant brings together minimal design and lab-grown diamond detailing to create a meaningful everyday necklace that feels intimate, elegant, and uniquely yours.",
    ...
    variants: [
      {
        ...
        metal: "925 Silver",
        weight: "4.0 gms",
        diamondDetails: "3.00 mm x 10 pcs",
        totalCarat: 1.01,
        price: 17999,
      },
      {
  ...
  },
  {
    ...
    collection: "The Everyday Edit",
    description:
      "The Lune Bracelet is designed for quiet everyday elegance, with a minimal diamond detail that adds just the right amount of shine. Delicate and versatile, it can be worn on its own or layered with your favourite bracelets.",
    shortDescription: "Minimal diamond bracelet for daily wear.",
    designType: "Bracelet",
    stoneType: "Lab-grown diamonds",
    stoneShapeOptions: "Small round diamonds",
    sizeOptions: "Wrist size / adjustable",
    customizable: true,
    inventoryModel: "Made-to-order",
    launchPriority: "Core launch",
    primaryChannel: "Website + Instagram",
    notes: "Clarify silver chain sourcing if needed",
    images: {
      silver: ["/products/lune-bracelet/1.png"],
      gold: ["/products/lune-bracelet/1.png"],
      vermeil: ["/products/lune-bracelet/1.png"],
    },
    variants: [
      {
        sku: "ETH-BR-001-VRM",
        metal: "Gold Vermeil on 925 Silver",
        weight: "1.5 gms",
        diamondDetails: "Oval 8.00 x 6.00 mm x 1 pc",
        totalCarat: 1.09,
        price: 41000,
      },
      {
