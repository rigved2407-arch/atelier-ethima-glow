...
import { JsonLd, orgJsonLd, websiteJsonLd } from "@/components/seo";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://ethima.in/products/ethima-diamond-hoops/silver-1.png" },
      { name: "twitter:image", content: "https://ethima.in/products/ethima-diamond-hoops/silver-1.png" },
