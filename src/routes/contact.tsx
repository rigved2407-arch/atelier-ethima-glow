...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — ethima | Get in Touch" },
      { name: "description", content: "Get in touch with the ethima atelier. Email, WhatsApp, or Instagram — we're here to help you create your perfect piece." },
      { name: "keywords", content: "contact ethima, ethima jewellery, fine jewellery india, whatsapp jewellery" },
      { property: "og:title", content: "Contact — ethima" },
      { property: "og:description", content: "Get in touch with the ethima atelier." },
      { name: "robots", content: "index, follow" },
    ],
    links: [{ rel: "canonical", href: "https://ethima.in/contact" }],
  }),
  component: Contact,
});
...
function Contact() {
  ...
  <li className="flex items-start gap-4"><Mail className="mt-0.5 h-4 w-4 text-champagne" />
    <a href="mailto:hello@ethima.in" className="hover:text-champagne transition-colors">hello@ethima.in</a>
  </li>
  <li className="flex items-start gap-4"><Phone className="mt-0.5 h-4 w-4 text-champagne" />
    <a href="tel:+918347867232" className="hover:text-champagne transition-colors">+91 83478 67232</a>
  </li>
  <li className="flex items-start gap-4"><MessageCircle className="mt-0.5 h-4 w-4 text-champagne" />
    <a href="https://wa.me/918347867232" target="_blank" rel="noopener noreferrer" className="hover:text-champagne transition-colors">Chat on WhatsApp</a>
  </li>
